...
@section('main-content')
    ...
    <a class="btn btn-primary" href="{{ route('banner.create') }}" role="button">Ajouter</a>
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">List de toutes les banners</h6>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach($banners as $banner)
                                    <tr>
                                        <td>
                                            <img src="{{ asset($banner->image ? $banner->image->path : '') }}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ date('d/m/Y à H:i:s', strtotime($banner->updated_at)) }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <div class="d-flex gap-2 w-100 justify-content-end">
                                                <a href="{{route('banner.edit', $banner)}}" class="btn btn-primary" data-toggle="tooltip" data-original-title="Edit user">
                                                    Editer
                                                </a>
