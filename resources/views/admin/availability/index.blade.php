...
@section('main-content')
    ...
    <a class="btn btn-primary" href="{{ route('availability.create') }}" role="button">Ajouter</a>
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            @foreach($availabilities as $availability)
                                <tr>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $availability->name }}</h6>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <span class="badge badge-sm bg-gradient-success">{{ $availability->delete_at == null ? 'OnLine' : 'OnffLine' }}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ date('d/m/Y à H:i:s', strtotime($availability->updated_at)) }}</span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex gap-2 w-100 justify-content-end">
                                            <a href="{{route('availability.edit', $availability)}}" class="btn btn-primary" data-toggle="tooltip" data-original-title="Edit user">
                                                Editer
                                            </a>
